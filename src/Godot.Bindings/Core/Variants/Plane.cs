...
public struct Plane : IEquatable<Plane>
{
    ...
    public readonly bool HasPoint(Vector3 point, real_t tolerance = Mathf.Epsilon)
    {
        ...
        return real_t.Abs(dist) <= tolerance;
    }
    ...
    {
        return _normal.IsFinite() && real_t.IsFinite(D);
    }
    ...
    {
        return _normal.IsEqualApprox(other._normal)
            && Mathf.IsEqualApprox(_d, other._d);
    }
