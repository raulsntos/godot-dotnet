    ...
    IDisposable
{
    ...
    /// </summary>
    internal static PackedStringArray CreateCopying(NativeGodotPackedStringArray nativeValueToCopy)
    {
        return new PackedStringArray(NativeGodotPackedStringArray.Create(nativeValueToCopy));
    }
