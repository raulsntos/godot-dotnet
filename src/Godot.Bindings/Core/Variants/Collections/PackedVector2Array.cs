...
public sealed class PackedVector2Array :
    IList<Vector2>,
    IReadOnlyList<Vector2>,
    IDisposable
{
    internal readonly NativeGodotPackedVector2Array.Movable NativeValue;

    private readonly WeakReference<IDisposable>? _weakReferenceToSelf;

    /// <summary>
    /// Constructs a new empty <see cref="PackedVector2Array"/>.
    /// </summary>
    /// <returns>A new Packed Vector2 Array.</returns>
    public PackedVector2Array()
    {
        NativeValue = NativeGodotPackedVector2Array.Create().AsMovable();
        _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
    }

    private PackedVector2Array(NativeGodotPackedVector2Array nativeValueToOwn)
    {
        NativeValue = (nativeValueToOwn.IsAllocated
            ? nativeValueToOwn
            : NativeGodotPackedVector2Array.Create()).AsMovable();
        _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
    }
    ...
    /// <returns>A new Packed Vector2 Array.</returns>
    public PackedVector2Array(IEnumerable<Vector2> collection)
    {
        ...
        if (collection is PackedVector2Array packedArray)
        {
            NativeValue = NativeGodotPackedVector2Array.Duplicate(ref packedArray.NativeValue.DangerousSelfRef).AsMovable();
            return;
        }
        if (collection is Vector2[] array)
        {
            NativeValue = NativeGodotPackedVector2Array.Create(array).AsMovable();
            return;
        }
    ...
    /// </summary>
    internal static PackedVector2Array CreateTakingOwnership(NativeGodotPackedVector2Array nativeValueToOwn)
    {
        return new PackedVector2Array(nativeValueToOwn);
    }
    ...
    /// <summary>
    /// Disposes of this <see cref="PackedVector2Array"/>.
    /// </summary>
    public void Dispose()
    {
        Dispose(true);
    ...
    /// </summary>
    /// <returns>The span representation of the array.</returns>
    public Span<Vector2> AsSpan(int start)
    {
    ...
    /// </summary>
    /// <returns>The span representation of the array.</returns>
    public Span<Vector2> AsSpan(int start, int length)
    {
    ...
    /// </summary>
    /// <returns>The span representation of the array.</returns>
    public Span<Vector2> AsSpan(Index startIndex)
    {
    ...
    /// </summary>
    /// <returns>The span representation of the array.</returns>
    public Span<Vector2> AsSpan(Range range)
    {
    ...
    /// <summary>
    /// Returns the number of elements in this <see cref="PackedVector2Array"/>.
    /// This is also known as the size or length of the array.
    /// </summary>
    /// <returns>The number of elements.</returns>
    public int Count => checked((int)NativeGodotPackedVector2Array.GetSize(in NativeValue.DangerousSelfRef));

    bool ICollection<Vector2>.IsReadOnly => false;

    /// <summary>
    /// Adds an item to the end of this <see cref="PackedVector2Array"/>.
    ...
    public void Add(Vector2 item)
    {
        ...
        NativeGodotPackedVector2Array.Append(ref self, item);
    }

    /// <summary>
    /// Adds the elements of the specified collection to the end of this <see cref="PackedVector2Array"/>.
    /// </summary>
    /// <exception cref="ArgumentNullException">
    /// The <paramref name="collection"/> is <see langword="null"/>.
    /// </exception>
    /// <param name="collection">Collection of <see langword="Vector2"/> items to add.</param>
    public void AddRange(IEnumerable<Vector2> collection)
    {
        ArgumentNullException.ThrowIfNull(collection);
        ...
        if (collection is Vector2[] array)
        {
            // If the collection is a Vector2 array, we can add the items
            // with a Span copy instead of iterating each element.
    ...
    private void AddRangeCore(ReadOnlySpan<Vector2> span)
    {
        int oldCount = Count;
    ...
    private void AddRangeCore(IEnumerable<Vector2> collection)
    {
    ...
    public bool Contains(Vector2 item) => IndexOf(item) != -1;

    /// <summary>
    /// Copies the elements of this <see cref="PackedVector2Array"/> to the given
    ...
    /// <summary>
    /// Returns a copy of the <see cref="PackedVector2Array"/>.
    /// </summary>
    /// <returns>A new Packed Vector2 Array.</returns>
    public PackedVector2Array Duplicate()
    {
        ref NativeGodotPackedVector2Array self = ref NativeValue.DangerousSelfRef;
        NativeGodotPackedVector2Array newArray = NativeGodotPackedVector2Array.Duplicate(ref self);
    ...
    public void Fill(Vector2 value)
    {
        ref NativeGodotPackedVector2Array self = ref NativeValue.DangerousSelfRef;
        NativeGodotPackedVector2Array.Fill(ref self, value);
    }
    ...
    /// <returns>The index of the item, or -1 if not found.</returns>
    public int IndexOf(Vector2 item, int index)
    {
    ...
    /// <param name="item">The <see langword="Vector2"/> item to search for.</param>
    /// <returns>The index of the item, or -1 if not found.</returns>
    public int LastIndexOf(Vector2 item)
    {
    ...
    /// <param name="index">The initial search index to start from.</param>
    /// <returns>The index of the item, or -1 if not found.</returns>
    public int LastIndexOf(Vector2 item, int index)
    {
    ...
    public void Insert(int index, Vector2 item)
    {
        ...
        ref NativeGodotPackedVector2Array self = ref NativeValue.DangerousSelfRef;
        NativeGodotPackedVector2Array.Insert(ref self, index, item);
    }

    /// <summary>
    /// Removes the first occurrence of the specified <paramref name="item"/>
    /// from this <see cref="PackedVector2Array"/>.
    /// </summary>
    ...
    /// <see cref="Remove(Vector2)"/> instead.
    /// </summary>
    /// <exception cref="ArgumentOutOfRangeException">
    /// <paramref name="index"/> is less than 0 or greater than the array's size.
    /// </exception>
    ...
    public void RemoveAt(int index)
    {
        ...
        ref NativeGodotPackedVector2Array self = ref NativeValue.DangerousSelfRef;
        NativeGodotPackedVector2Array.RemoveAt(ref self, index);
    }
    ...
    {
        ref NativeGodotPackedVector2Array self = ref NativeValue.DangerousSelfRef;
        return (Error)NativeGodotPackedVector2Array.Resize(ref self, newSize);
    }
    ...
    {
        ref NativeGodotPackedVector2Array self = ref NativeValue.DangerousSelfRef;
        NativeGodotPackedVector2Array.Reverse(ref self);
    }

    /// <summary>
    /// Creates a copy of a range of elements in the source <see cref="PackedVector2Array"/>.
    ...
    public PackedVector2Array Slice(int start)
    {
    ...
    /// <returns>A new array that contains the elements inside the slice range.</returns>
    public PackedVector2Array Slice(int start, int length)
    {
        ArgumentOutOfRangeException.ThrowIfNegative(start);
        ArgumentOutOfRangeException.ThrowIfGreaterThan(start, Count);
    ...
    private PackedVector2Array SliceCore(int start, int end)
    {
        ref NativeGodotPackedVector2Array self = ref NativeValue.DangerousSelfRef;
        NativeGodotPackedVector2Array newArray = NativeGodotPackedVector2Array.Slice(in self, start, end);
        return CreateTakingOwnership(newArray);
    }
    ...
    {
        ref NativeGodotPackedVector2Array self = ref NativeValue.DangerousSelfRef;
        NativeGodotPackedVector2Array.Sort(ref self);
    }

    // IEnumerable

    /// <summary>
    /// Gets an enumerator for this <see cref="PackedVector2Array"/>.
    /// </summary>
    ...
    /// <summary>
    /// Provides an enumerator for the elements of a <see cref="PackedVector2Array"/>.
    /// </summary>
    public struct Enumerator : IEnumerator<Vector2>
    {
        private readonly PackedVector2Array _array;
        private int _index;
        ...
        internal Enumerator(PackedVector2Array array)
        {
            _array = array;
            _index = 0;
            _current = default;
    ...
    private sealed class DebugView
    {
        ...
        public DebugView(PackedVector2Array array)
        {
            ArgumentNullException.ThrowIfNull(array);
            _array = array;
        }
        ...
        public Vector2[] Items => [.. _array];
    }

    /// <summary>
    /// Converts this <see cref="PackedVector2Array"/> to a string.
    /// </summary>
