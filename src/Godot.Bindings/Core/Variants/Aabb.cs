...
public struct Aabb : IEquatable<Aabb>
{
    ...
    public readonly Vector3 GetEndpoint(int idx)
    {
        return idx switch
        {
            0 => new Vector3(_position.X, _position.Y, _position.Z),
            1 => new Vector3(_position.X, _position.Y, _position.Z + _size.Z),
            2 => new Vector3(_position.X, _position.Y + _size.Y, _position.Z),
            3 => new Vector3(_position.X, _position.Y + _size.Y, _position.Z + _size.Z),
            4 => new Vector3(_position.X + _size.X, _position.Y, _position.Z),
    ...
    {
        return _position.IsEqualApprox(other._position)
            && _size.IsEqualApprox(other._size);
    }
