...
public class MyType
{
    ...
    {
        // These two calls raise a GODOT0802 diagnostic error: T is not valid here because it may not a Variant type and method call and class require it.
        new ExampleClass<{|GODOT0802:T|}>();
        Method<{|GODOT0802:T|}>();
    }
