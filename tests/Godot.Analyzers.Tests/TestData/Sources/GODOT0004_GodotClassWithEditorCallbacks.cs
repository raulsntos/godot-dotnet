...
public partial class MyNode : Node
{
    ...
    protected override void {|GODOT0004:_GetPropertyList|}(IList<PropertyInfo> properties) { }

    protected override bool {|GODOT0004:_PropertyCanRevert|}(StringName property)
    {
        return false;
    }

    protected override bool {|GODOT0004:_PropertyGetRevert|}(StringName property, out Variant value)
    {
        value = default;
        return false;
    }

    protected override void {|GODOT0004:_ValidateProperty|}(PropertyInfo property) { }
}
